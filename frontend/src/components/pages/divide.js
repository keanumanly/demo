...
import { Adding,GetList,Deleting,Updating } from "../action/division"
...
export default function Division(props) {
  ...
  function AddRow(arg){
    console.log(arg)
    let count = 0;
    if(parseInt(arg.numy) !== 0){
        console.log('num y :',arg.numy)
